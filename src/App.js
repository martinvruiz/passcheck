  ...
  return (
    <div className="bg-blue-500 font-parkinsans min-w-full min-h-screen flex flex-col items-center">
      ...
      <section className="flex justify-center">
        ...
        text3="No guardamos ningun tipo de dato, la app solo chequea que tu contraseña cumpla con estos requisitos. No hay un limite para probar estas, podes dejar volar tu imaginacion para que sean seguras pero no olvides que tienen que ser faciles de recordar!"
        />
      </section>
    </div>
  );
